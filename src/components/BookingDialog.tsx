...
const BookingDialog = ({ propertyId, propertyTitle, available }: BookingDialogProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({ title: "Booking request sent!", description: "The landlord will be notified of your interest." });
    setOpen(false);
    setPhone("");
    setMessage("");
  };
